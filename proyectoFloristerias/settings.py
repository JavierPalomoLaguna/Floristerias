...
ROOT_URLCONF = 'proyectoFloristerias.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [os.path.join(BASE_DIR, 'proyectoFloristerias', 'templates')],  # ← CAMBIAR AQUÍ
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'proyectoFloristerias.wsgi.application'
...
if ENV == 'production':
    ...
    STATICFILES_DIRS = [
        os.path.join(BASE_DIR, 'static'),
        os.path.join(BASE_DIR, 'FloristeriasApp/static'),
    ]
